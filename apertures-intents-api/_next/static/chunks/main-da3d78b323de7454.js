        ...
        getRouteInfo(e) {
          ...
          return n(function* () {
            ...
            try {
              ...
              if (j.isAPIRoute(e))
                return X({ url: i, router: P }), new Promise(() => {});
              let M =
                  C ||
              ...
              return (
                M.__N_SSP && O.dataHref && I && delete P.sdc[I],
                P.isPreview ||
                  !M.__N_SSG ||
                  g ||
                  G(
