  ...
  [4],
  {
    1736: function (t, e, n) {
      ...
      let o = (t) => {
        ...
        return (0, i.tZ)(r.Z, {
          ...n,
          inheritViewBox: !0,
          children: (0, i.tZ)("use", { href: "/sprite.svg#".concat(e) }),
        });
      };
    },
    2526: function (t, e, n) {
      ...
      let g = () => {
        ...
        return (
          ...
          s(() => {
            let t = a.ZP.context(() => {
              a.ZP.timeline({
                scrollTrigger: { scrub: !0, start: "1", end: "300" },
              }).to("#rotate-button", { rotation: 180, duration: 0.3 });
            });
            return () => t.revert();
          }, []),
          (0, i.tZ)(c.Z, {
                ...
                (0, i.BX)(c.Z, {
                  ...
                  children: [
                    (0, i.BX)(h.Z, {
                      ...
                      children: [
                        "Empower Your Vision with Declarative",
                        (0, i.tZ)("br", {}),
                ...
                (0, i.tZ)(c.Z, {
                  ...
                  children: (0, i.tZ)(m.Z, {
                    ...
                    sx: (t) => ({
                      width: 60,
                      height: 60,
                      [t.breakpoints.up("sm")]: { width: 100, height: 100 },
                    }),
                    children: (0, i.tZ)(o.J, {
                      sx: (t) => ({
                        width: 40,
                        height: 40,
                        [t.breakpoints.up("sm")]: { width: 48, height: 48 },
                      }),
                      name: "arrow",
                    }),
                  }),
      ...
      let w = x()(() => n.e(429).then(n.bind(n, 3429)), {
          loadableGenerated: { webpack: () => [3429] },
          ssr: !1,
        }),
        C = (t) => {
          let { data: e, isAmount: n = !1 } = t,
            { num: o, suffix: a } =
              e >= 1e9
                ? { num: (e / 1e9).toFixed(1), suffix: "B" }
                : e >= 1e6
                ? { num: (e / 1e6).toFixed(1), suffix: "M" }
                : { num: e, suffix: "" },
            [s, l] = (0, r.useState)(0);
          return (
            (0, r.useEffect)(() => {
            ...
            (0, i.BX)(h.Z, {
              variant: "h3",
              color: "text.primary",
              sx: (t) => ({ [t.breakpoints.down("sm")]: { fontSize: 24 } }),
              children: [
                n && (0, i.tZ)("span", { children: "$" }),
                (0, i.tZ)(w, {
        ...
        v = () => {
          let { palette: t } = (0, d.Z)(),
            ...
            [l, u] = (0, r.useState)();
          (0, r.useEffect)(() => {
            fetch("https://api.aperture.finance/getMetricsSinceInception")
              .then((t) => t.json())
              .then((t) => {
            ...
            s(() => {
              let t = a.ZP.context(() => {
                a.ZP.timeline({
                  ...
                  .to(l.current, { scale: 0, duration: 0.5 }, "<")
                  .to(
                    u.current,
                    { scale: 40, background: "#000", duration: 1 },
                    "<"
                  );
              });
              return () => t.revert();
              ...
              children: (0, i.BX)(p.Z, {
                children: [
                  ...
                  (0, i.BX)(f.Z, {
                    ...
                    children: [
                      (0, i.tZ)(h.Z, {
                        fontSize: { xs: 70, sm: 90, md: 200, lg: 220 },
                        fontWeight: 500,
                        lineHeight: 0.9,
                        color: "text.primary",
        ...
        y = [
          {
            ...
            description:
              "Using chatbots to translate natural language into a novel domain specific language for Intents allows users to express their views without the constraints of standard UX.",
          },
          {
            id: 2,
            title: "GASLESS EXPERIENCE",
            description:
              "Users can declare their Intents without needing to pay gas. Aperture Solvers will pay gas on the users behalf and deduct fees in tokens of the users choosing.",
          },
          {
            id: 3,
            title: "ROBUST SOLVER NETWORK",
            description:
              "From Propeller Heads to Enso and beyond. Aperture has quotes from multiple solvers to ensure users get the best execution and pricing possible.",
          },
        ];
      var H = n(2195),
        I = n(850),
      ...
      let V = () => {
          ...
          return (
            ...
            s(() => {
              let t = a.ZP.context(() => {
                ...
                }).to(l.current, { y: -820, duration: 60 });
                let t = a.ZP.timeline({
                  scrollTrigger: {
                    scrub: !0,
                    start: "-20% 50%",
                ...
                a.ZP.utils
                  .toArray(Array.from(Array(46).keys()))
                  .forEach((e) => {
                    t.to(o.current, { duration: 1 }),
                      t.set(
                        o.current,
                        {
                          attr: {
                            src: "/images/highlights/laptop/01".concat(
                              e,
                              ".png"
                            ),
                          },
                      ...
                      children: [
                        (0, i.tZ)(h.Z, {
                          ...
                          sx: (t) => ({
                            ...
                            [t.breakpoints.down("sm")]: { fontSize: 40 },
                            [t.breakpoints.down("md")]: { fontSize: 46 },
                          }),
                          children: "Aperture",
                        }),
                        (0, i.tZ)(h.Z, {
                        ...
                        (0, i.tZ)(h.Z, {
                          ...
                          children:
                            "Engineered by Silicon Valley's finest, Aperture AI offers seamless automation for both traditional finance (TradFi) funds and DeFi enthusiasts.",
                        }),
                      ],
                    }),
                    (0, i.tZ)(f.Z, {
                ...
                (0, i.tZ)(p.Z, {
                  ...
                  children: (0, i.tZ)(c.Z, {
                    ...
                    divider: (0, i.tZ)(P.Z, {
                      ...
                      flexItem: !0,
                      sx: { borderColor: "rgba(255,255,255,.3)" },
                    }),
                    sx: {
                    ...
                    children: y.map((t) => {
                      let { id: e, title: n, description: r } = t;
                      return (0, i.BX)(
                        c.Z,
                        {
                          justifyContent: "center",
                          sx: (t) => ({
                            position: "relative",
                            minHeight: { xs: 148, sm: 120 },
                            [t.breakpoints.down("md")]: { py: 3 },
                            [t.breakpoints.up("md")]: {
                              ".MuiTypography-root": { transition: ".3s" },
                              ":hover": {
                                ".MuiTypography-root": {
                                  opacity: 0,
          ...
          return (
            ...
            s(() => {
              let i = a.ZP.context(() => {
                ...
                }).to(e.current, { yPercent: -250, duration: 1e3 }, 1),
                  a.ZP.timeline({
                    scrollTrigger: { scrub: !0, trigger: n.current },
                  }).to(o.current, { scaleX: 1.5, duration: 0.1 }, "+=20%"),
                  a.ZP.timeline({
                    scrollTrigger: {
                      pin: !0,
                      trigger: t.current,
              ...
              children: [
                ...
                (0, i.BX)(c.Z, {
                  ...
                  sx: (t) => ({
                    ...
                    zIndex: 3,
                    width: "100%",
                    [t.breakpoints.down("sm")]: { pt: "100px" },
                  }),
                  children: [
                    (0, i.tZ)(p.Z, {
                      children: (0, i.BX)(c.Z, {
        ...
        T = [
          { id: 0, image: "uniswap.svg" },
          { id: 1, image: "pancakeswap.svg" },
          { id: 2, image: "propellerhead.svg" },
          { id: 3, image: "mantanetwork.svg" },
          { id: 4, image: "polygon.svg" },
          { id: 5, image: "optimism.svg" },
          { id: 6, image: "arbitrum.svg" },
          { id: 7, image: "binancesmartchain.svg" },
          { id: 8, image: "binancelabs.svg" },
        ];
      var M = n(3743);
      let B = (t) => {
          let { animate: e } = t,
          ...
          return (0, i.tZ)(f.Z, {
            sx: (t) => ({
              ...
              height: 113,
              width: "100%",
              [t.breakpoints.up("sm")]: { height: 162 },
            }),
            children: (0, i.tZ)(c.Z, {
              direction: "row",
              gap: 3,
              sx: {
                position: "absolute",
                animation: "".concat(
                  "left" === e ? "slide" : "slideReverse",
                  " 300s linear infinite"
                ),
                "@keyframes slide": {
                  "0%": { transform: "translate(0)" },
                  "100%": { transform: "translate(calc(-100% + 100vw), 0px)" },
                },
                "@keyframes slideReverse": {
                  "0%": { transform: "translate(calc(-100% + 100vw), 0px)" },
                  ...
                  c.Z,
                  {
                    ...
                    children: (0, i.tZ)(f.Z, {
                      ...
                      sx: (t) => ({
                        ...
                        objectFit: "contain",
                        fontFamily: '"object-fit: contain;"',
                        [t.breakpoints.up("sm")]: { width: 180, height: 70 },
                      }),
                    }),
                  },
                  e
            ...
            (0, i.BX)(f.Z, {
              ...
              children: [
                ...
                (0, i.BX)(c.Z, {
                  gap: { xs: "18px", sm: 3 },
                  children: [
                    (0, i.tZ)(B, { animate: "left" }),
                    (0, i.tZ)(B, { animate: "right" }),
                  ],
                }),
              ],
            })
        ...
        z = () => {
          ...
          return (
            ...
            s(() => {
              let i = a.ZP.context(() => {
                a.ZP.timeline({
                  scrollTrigger: { scrub: !0, pin: !0, trigger: t.current },
                })
                  .to(e.current, { scale: 1, duration: 1 })
                  .to(n.current, { y: "0", opacity: 1, duration: 1 }, "-=.7")
                  .to(l.current, { y: "0", opacity: 1, duration: 1.2 }, "<");
              });
              return () => i.revert();
            }, []),
            (0, i.BX)(c.Z, {
                        ...
                        children: [
                          (0, i.tZ)(h.Z, {
                            ...
                            sx: (t) => ({
                              ...
                              lineHeight: 1.3,
                              letterSpacing: "1px",
                              [t.breakpoints.down("sm")]: { fontSize: 46 },
                            }),
                          ...
                          (0, i.tZ)(h.Z, {
                            ...
                            sx: (t) => ({
                              ...
                              lineHeight: 1.2,
                              letterSpacing: "-0.4px",
                              [t.breakpoints.up("sm")]: { fontSize: 20 },
                            }),
                            children:
                              "For asset managers and individuals planning to invest over $100,000 please reach out to our team for exclusive perks and resources.",
                          }),
                        ],
                      }),
                      (0, i.tZ)(c.Z, {
                        ...
                        sx: { opacity: 0, transform: "translateY(150px)" },
                        children: (0, i.BX)(c.Z, {
                          component: "a",
                          direction: "row",
                          alignItems: "center",
        ...
        F = () => {
          ...
          return (
            ...
            (0, i.tZ)(f.Z, {
              sx: {
                background: "#000",
                padding: { xs: "90px 0 80px", sm: "260px 0 80px" },
              },
              children: (0, i.BX)(p.Z, {
                children: [
                  (0, i.tZ)(c.Z, {
      ...
      let _ = () => {
          ...
          return (
            ...
            (0, i.BX)(i.HY, {
              children: [
                (0, i.tZ)(p.Z, {
                  sx: { height: { md: "100vh" }, color: "primary.main" },
                ...
                (0, i.BX)(D.ZP, {
                  container: !0,
                  sx: { position: { md: "absolute" }, top: 0 },
                  children: [
                    (0, i.tZ)(D.ZP, { item: !0, md: 7, xs: 12 }),
                    (0, i.tZ)(N, {
                      component: c.Z,
                      item: !0,
                      xs: 12,
        ...
        N = (0, X.ZP)(D.ZP)((t) => {
          ...
          return {
            ...
            fontSize: "14px",
            [e.breakpoints.up("md")]: { fontSize: "20px" },
            [e.breakpoints.down("md")]: { margin: "0 24px" },
            "&:before": {
              content: '""',
              display: "block",
              background:
                "light" === e.palette.mode
                  ? "linear-gradient(180deg, rgba(255,255,255,1) 10%, rgba(1,110,150,0) 32%, rgba(0,167,209,0) 68%, rgba(254,255,255,1) 90%)"
                  : "linear-gradient(180deg, rgba(18,18,18,1) 5%, rgba(1,110,150,0) 32%, rgba(0,167,209,0) 68%, rgba(18,18,18,1) 90%)",
              width: "100%",
              height: "100%",
              position: "relative",
              zIndex: 2,
        ...
        U = () => {
          ...
          return (
            ...
            (0, i.tZ)(p.Z, {
              sx: { color: "primary.main", pt: { md: 10 } },
              children: (0, i.BX)(c.Z, {
                alignItems: "center",
                sx: { textAlign: "center" },
                pb: 12,
                  ...
                  (0, i.BX)(c.Z, {
                    ...
                    children: [
                      (0, i.tZ)(u.Z, {
                        variant: "contained",
                        sx: (t) => ({
                          [t.breakpoints.down("md")]: { fontSize: 14 },
                        }),
                        onClick: () =>
                          window.open(
                      ...
                      (0, i.tZ)(u.Z, {
                        ...
                        onClick: () =>
                          window.open("mailto:contact@aperture.finance"),
    ...
    5687: function (t, e, n) {
          ...
          return (0, i.BX)(l.Z, {
            ...
            children: [
              ...
              (0, i.tZ)(d.Z, {
                ...
                children: (0, i.tZ)(a.J, {
                  sx: [
                    "small" === n && { width: 12, height: 12 },
                    "medium" === n && { width: 20, height: 20 },
                  ],
                  name: "x.com",
                }),
              }),
              ...
              children: [
                    ...
                    (0, i.tZ)(m.ZP, {
                      ...
                      children: (0, i.BX)("ul", {
                        children: [
                          ...
                          (0, i.tZ)("li", {
                            children: (0, i.tZ)("a", {
                              href: "https://docs.aperture.finance/docs/technical-docs/api-documentation",
                              target: "_blank",
                              children: "API",
                            }),
                          }),
                          (0, i.tZ)("li", {
                            children: (0, i.tZ)("a", {
                              href: "https://app.aperture.finance/",
                              target: "_blank",
                              children: "Aperture Product",
                            }),
                          }),
                        ],
                      }),
                    ...
                    (0, i.tZ)(m.ZP, {
                      ...
                      children: (0, i.BX)("ul", {
                        children: [
                          ...
                          (0, i.tZ)("li", {
                            children: (0, i.tZ)("a", {
                              href: "https://docs.aperture.finance/docs",
                              target: "_blank",
                              children: "docs",
                            }),
                          }),
                          (0, i.tZ)("li", {
                            children: (0, i.tZ)("a", {
                              href: "https://linktr.ee/ApertureFinance",
                              target: "_blank",
                              children: "Linktree",
                            }),
                          }),
                    ...
                    (0, i.tZ)(m.ZP, {
                      ...
                      children: (0, i.BX)("ul", {
                        children: [
                          ...
                          (0, i.tZ)("li", {
                            children: (0, i.tZ)("a", {
                              href: "mailto:partners@aperture.finance",
                              target: "_blank",
                          ...
                          (0, i.tZ)("li", {
                            children: (0, i.tZ)("a", {
                              href: "mailto:contact@aperture.finance",
                              target: "_blank",
                    ...
                    (0, i.tZ)(m.ZP, {
                      ...
                      children: (0, i.BX)("ul", {
                        children: [
                          ...
                          (0, i.tZ)("li", {
                            children: (0, i.tZ)("a", {
                              href: "https://app.aperture.finance/privacy",
                              target: "_blank",
                          ...
                          (0, i.tZ)("li", {
                            children: (0, i.tZ)("a", {
                              href: "https://app.aperture.finance/terms",
                              target: "_blank",
                ...
                (0, i.BX)(g.Z, {
                  ...
                  children: [
                    (0, i.tZ)(p, {
                      direction: "row",
                      sxElem: { backgroundColor: "#fff", color: "#000" },
                      spacing: { xs: 1.5, sm: 2 },
                    }),
                    (0, i.tZ)(g.Z, {
                      sx: {
        ...
        b = (0, Z.ZP)(g.Z)((t) => {
          ...
          return {
            ul: {
              ...
              li: {
                margin: "23px 0 10px",
                [e.breakpoints.up("sm")]: { margin: "28px 0 10px" },
              },
            },
            ".title p": {
              fontWeight: 500,
      ...
      var k = n(9097),
        ...
        P = n(1721);
      let V = (t) => {
          let { open: e, onToggle: n, colorInvert: r = !1 } = t,
            { palette: o } = (0, s.Z)(),
            { mode: a } = o;
          return (0, i.BX)(g.Z, {
            onClick: () => n(!e),
            sx: [
              ...
              !r && { background: "#000", span: { background: "#fff" } },
              r && {
                background: "dark" === a ? "#000" : "#fff",
                span: { background: "dark" === a ? "#fff" : "#000" },
              },
              e && {
                "span:nth-child(1)": {
        ...
        A = (t) => {
          let { open: e, onToggleMenu: n } = t,
            c = (0, o.useRouter)(),
            { palette: u } = (0, s.Z)(),
            { mode: m } = u,
            { toggleColorMode: g } = (0, r.useContext)(H.ColorModeContext),
            Z = (t) => {
              n(!1), c.push(t);
            };
          return (0, i.BX)(I.ZP, {
            ...
            children: [
                ...
                children: [
                  ...
                  (0, i.BX)(l.Z, {
                    ...
                    children: [
                      ...
                      (0, i.tZ)(V, { open: e, onToggle: n, colorInvert: !0 }),
                    ],
                  }),
                ],
              }),
                ...
                children: [
                  ...
                  (0, i.BX)(l.Z, {
                    ...
                    children: [
                      ...
                      (0, i.tZ)(a.J, {
                        sx: { width: 14, height: 14, ml: 1, color: "#F9C13D" },
                        name: "arrow-up-right",
                      }),
                    ],
                  }),
              ...
              (0, i.tZ)(p, { direction: "row", size: "medium", spacing: 3 }),
            ],
          });
        };
      var S = n(4682),
        R = n(850);
      let T = () => {
          let { palette: t, breakpoints: e } = (0, s.Z)(),
            { mode: n } = t,
            o = (0, R.Z)(e.down("md")),
            [d, c] = (0, r.useState)(!1);
          (0, r.useEffect)(() => {
            S.ZP.timeline({
              scrollTrigger: { scrub: !0, start: "200", end: "300" },
            }).to("#opacity-logo", { opacity: 0, duration: 0.3 });
          }, []);
          let p = (t) => {
            c(t);
          };
          return (0, i.BX)(l.Z, {
            ...
            children: [
              ...
              o &&
                (0, i.BX)(i.HY, {
                  children: [
                    (0, i.tZ)(V, { open: d, onToggle: p }),
                    (0, i.tZ)(A, { open: d, onToggleMenu: p }),
                  ],
                }),
            ],
          });
        ...
        M = () => {
          let t = (0, o.useRouter)(),
            { toggleColorMode: e } = (0, r.useContext)(H.ColorModeContext),
            { palette: n } = (0, s.Z)(),
            { mode: d } = n,
            [c, p] = (0, r.useState)({}),
            [u, m] = (0, r.useState)(0),
          ...
          let w = (t, e) => {
              ...
              if (
                (m(e),
                "string" ==
                  typeof (null === (n = t.target) || void 0 === n
                    ? void 0
                    : n.className) &&
                  (null === (i = t.target) || void 0 === i
                    ? void 0
                    : null === (r = i.className) || void 0 === r
                    ? void 0
                    : r.includes("hover-nav")))
              ) {
                let e = t.target,
          ...
          return (0, i.BX)(B, {
            ...
            children: [
              (0, i.tZ)(L, {
                sx: { width: 0, overflow: "hidden", opacity: 0, p: 0 },
                id: "float-nav",
                children: (0, i.tZ)(y(), {
                  href: h.s6,
                  id: "float-logo",
        ...
        B = (0, Z.ZP)(l.Z)((t) => {
          ...
          return {
            ...
            borderRadius: "100px",
            background:
              "light" === e.palette.mode ? "#000" : "rgba(44, 44, 44, 1)",
            left: "50%",
        ...
        z = (0, Z.ZP)("div")((t) => {
          ...
          return {
            ...
            borderRadius: 100,
            background:
              "light" === e.palette.mode ? "#fff" : "rgba(18, 18, 18, 1)",
            zIndex: 0,
            cursor: "pointer",
          };
        }),
        F = (t) => {
          ...
          return (0, i.BX)(i.HY, {
            children: [
              ...
              (0, i.tZ)(M, {}),
              (0, i.tZ)("main", { className: "wrapper", children: e }),
              (0, i.tZ)(x, {}),
            ],
          });
        };
